...
const translations = {
  ...
  de: {
    ...
    'biketransport-citybike': 'Ich benutze ein citybike',
    ...
    'trip-co2-emissions': 'Emissionen der Reise',
  ...
  en: {
    ...
    call: 'Call',
    'calories-walked': 'Calories walked',
    cancel: 'Cancel',
    canceled: 'Canceled',
    ...
    'trip-calories': 'Calories burned on the journey',
  ...
  es: {
    ...
    'trip-co2-emissions': 'Emisiones del viaje',
    ...
    'trip-co2-emissions': 'Reitin päästöt',
  ...
  fr: {
    ...
    'trip-co2-emissions': 'Émissions de voyage',
  ...
  pt: {
    ...
    'add-location-to-favourites': 'Adicionar uma localização importante aos seus favoritos',
    address: 'Morada',
    ...
    call: 'Ligar',
    'calories-walked': 'Calorias caminhadas',
    cancel: 'Cancelar',
    canceled: 'Cancelado',
    car: 'Carro',
    ...
    'citybike-register-required': 'É necessário registar para utilizar bicicletas da cidade',
    ...
    'cyclewalk-distance-duration': 'Ande com a sua bicicleta {distance} ({duration})',
    ...
    'departure-time-in-minutes': '{minutes} min',
    departures: 'Partidas',
    description: 'Encontre serviços de transportes públicos para diversas localizações.',
    destination: 'Destino',
    'destination-outside-service':
    ...
    'disruption-info-no-alerts': 'Não são conhecidas reduções ou alterações de serviço.',
    'disruption-info-route-no-alerts':
    ...
    'give-name-to-location': 'Dê um nome descritivo ao local',
    'give-origin': 'Introduza o seu ponto de origem.',
    'give-position': 'Introduza a sua localização ou origem no campo de pesquisa.',
    'give-route': 'Pesquisar rota',
    hour: 'Hora',
    'hour-short': 'h',
    'how-to-rate-service': 'Como avalia o serviço?',
    'in-addition': 'Em adição',
    inquiry: 'O que pensa do Journey Planner? Por favor diga-nos!', /*Journey Planner*/
    instructions: 'Instruções',
    'itinerary-feedback-button': 'Enviar feedback',
    'itinerary-feedback-message': 'Não conseguiu encontrar o que estava à procura?',
    ...
    'journeyplanner.title': 'Multi Modal Transportation', /*HSL Journey Planner*/
    later: 'Mais tarde',    /*Depois*/
    leaves: 'Partida',
    'leaving-at': 'Parte',   /*Leaving at*/
    'likely-to-recommend':
      'Qual a probabilidade de recomendar o nosso serviço aos seus amigos ou colegas?',
    'likely-to-use':
      'Qual a probabilidade de utilizar este serviço em vez de um Planeador de viagem?',  // journey planner
    loading: 'A carregar...',
    ...
    'no-favourite-locations':
      'Adicione as suas localizações mais utilizadas aqui. Os botões irão planear a sua rota de imediato.',
    'no-favourites':
      'Utilize os botões de estrela para adicionar rotas ou paragens aos seus favoritos. Os seus favoritos aparecem nesta página.',
    ...
    'route-destination-endpoint': 'Chegadas / Terminal', /*Arrives / Terminus*/
    ...
    'route-page.description': 'Rota {route_short_name} - {route_long_name}',
    'route-page.title': 'Rota {route_short_name}',
    ...
    'route-prefer-winter-maintenance': 'Preferir rotas com manutenção de inverno',
    ...
    save: 'Guardar',
    search: 'Procurar',
    'search-destination': 'Procurar destino, rota ou paragem',
    'search-destination-results-but-no-search':
      'Ver resultados na aba “Destino” adjacente',
    'search-no-results': 'Sem localização',
    'search-origin': 'Procurar origem, rota ou paragem',
    ...
    'select-position': 'Selecione a sua localização das suas pesquisas anteriores',
    send: 'Enviar',
    settings: 'Definições',
    ...
    slow: 'Devagar',
    'specify-location': 'Especificar localização',
    ...
    'via-leg-stop-duration': 'No ponto intermédio {stayDuration}', /*At via point {stayDuration}*/
    'via': 'Via',
    'via-point': 'Ponto intermédio', /**/
    'viapoint-slack-amount': 'Duração da paragem',
    'view-route': 'Ver rota',
    wait: 'Esperar',
    'wait-amount-of-time': 'Esperar {duration}',
    walk: 'caminhando',
    'walking-distance': 'Distancia caminhada',
    ...
    'weather-at-destination': 'Tempo no destino',   /*Weather at the destination*/
    yesterday: 'Ontem',
    'your-favourites': 'Favoritos',
    zone: 'Zona',
